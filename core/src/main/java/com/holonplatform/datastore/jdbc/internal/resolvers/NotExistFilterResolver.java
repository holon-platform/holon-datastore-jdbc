...
public enum NotExistFilterResolver implements ExpressionResolver<NotExistsFilter, SQLToken> {
	 ...
	 */
	@Override
	public Optional<SQLToken> resolve(NotExistsFilter expression, ResolutionContext context)
