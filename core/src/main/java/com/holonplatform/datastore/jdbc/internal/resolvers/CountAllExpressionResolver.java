...
public enum CountAllExpressionResolver implements ExpressionResolver<CountAllExpression, SQLToken> {
	 ...
	 */
	@Override
	public Class<? extends CountAllExpression> getExpressionType() {
		return CountAllExpression.class;
	}
