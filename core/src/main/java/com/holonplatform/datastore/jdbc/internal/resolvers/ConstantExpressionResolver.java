...
public enum ConstantExpressionResolver implements ExpressionResolver<ConstantExpression, SQLToken> {
	 ...
	 */
	@Override
	public Optional<SQLToken> resolve(ConstantExpression expression, ResolutionContext context)
