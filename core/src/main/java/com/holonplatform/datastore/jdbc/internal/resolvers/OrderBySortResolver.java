...
/**
 * {@link JdbcOrderBySort} expression resolver.
 *
 * @since 5.0.0
 */
@Priority(Integer.MAX_VALUE - 100)
public enum OrderBySortResolver implements ExpressionResolver<JdbcOrderBySort, SQLToken> {
	 ...
	 */
	@Override
	public Class<? extends JdbcOrderBySort> getExpressionType() {
		return JdbcOrderBySort.class;
	}
	 ...
	 */
	@Override
	public Optional<SQLToken> resolve(JdbcOrderBySort expression,
			com.holonplatform.core.ExpressionResolver.ResolutionContext context) throws InvalidExpressionException {
		// validate
		expression.validate();
		// get SQL
		return Optional.of(SQLToken.create(expression.getSQL()));
	}
