...
public class JdbcDatastorePostgreIT extends AbstractJdbcDatastoreTestSuiteIT {

	@BeforeClass
	public static void initDatastore() {

		final DataSource dataSource = DataSourceBuilder.build("postgre/datasource.properties");
		initSQL(dataSource, "postgre/schema.sql", "postgre/data.sql");
