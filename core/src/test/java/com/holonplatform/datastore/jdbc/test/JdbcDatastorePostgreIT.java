...
@ContextConfiguration(classes = JdbcDatastorePostgreIT.Config.class)
@DirtiesContext
public class JdbcDatastorePostgreIT extends AbstractDatastoreIntegrationTest {
	...
	protected static class Config {
		...
		public DataSource dataSource() {
			DataSource ds = DataSourceBuilder.create().build(
					DataSourceConfigProperties.builder().withPropertySource("postgre/datasource.properties").build());
			// init
			initSQL(ds, "postgre/schema.sql", "postgre/data.sql");
			return ds;
		}
		...
		public JdbcDatastore datastore() {
			return JdbcDatastore.builder().dataSource(dataSource()).database(DatabasePlatform.POSTGRESQL)
