...
public class H2Test extends AbstractDatabaseSuiteTest {
	...
	public void testAutoIncrement() {
		...
		if (!isDatabase(DatabasePlatform.H2)) {
			return;
		}
		...
		inTransaction(() -> {
			...
			OperationResult result = getDatastore().insert(TEST2, box);
	...
	public void testCustomFunction() {
		...
		String result = getDatastore().query().withExpressionResolver(new IfNullFunctionResolver()).target(NAMED_TARGET)
