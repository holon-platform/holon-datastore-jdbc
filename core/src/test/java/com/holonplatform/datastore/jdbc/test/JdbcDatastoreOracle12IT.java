...
public class JdbcDatastoreOracle12IT extends AbstractJdbcDatastoreTestSuiteIT {

	@BeforeClass
	public static void initDatastore() {

		final DataSource dataSource = DataSourceBuilder.build("oracle12/datasource.properties");
		initSQL(dataSource, "oracle12/schema.sql", "oracle12/data.sql");
