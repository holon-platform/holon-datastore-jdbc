...
public enum NotExistFilterResolver implements SQLExpressionResolver<NotExistsFilter> {
	 ...
	 */
	@Override
	public Optional<SQLExpression> resolve(NotExistsFilter expression, SQLCompositionContext context)
