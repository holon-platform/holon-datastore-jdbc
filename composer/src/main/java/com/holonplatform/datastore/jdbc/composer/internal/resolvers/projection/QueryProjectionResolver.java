...
public enum QueryProjectionResolver implements SQLContextExpressionResolver<QueryProjection, SQLProjection> {
	 ...
	 */
	@Override
	public Optional<SQLProjection> resolve(QueryProjection expression, SQLCompositionContext context)
		...
		return context.resolve(expression, QueryProjection.class).flatMap(resolved -> {
			...
			return context.resolve(resolved, SQLProjection.class);
		});
	}
