...
/**
 * Default {@link SQLValueSerializer}.
 *
 * @since 5.1.0
 */
public enum DefaultSQLValueSerializer implements SQLValueSerializer {
	...
	/*
	 * (non-Javadoc)
	 * @see com.holonplatform.datastore.jdbc.composer.SQLValueSerializer#serialize(java.lang.Object,
	...
	public String serialize(Object value, TemporalType temporalType) {
		if (value != null) {
			...
			// Date and times
			Optional<String> serializedDate = serializeTemporal(value, temporalType);
	...
	/*
	 * (non-Javadoc)
	 * @see com.holonplatform.datastore.jdbc.composer.SQLValueSerializer#serializeTemporal(java.lang.Object,
	 * com.holonplatform.core.temporal.TemporalType)
	 */
	@Override
	public Optional<String> serializeTemporal(Object value, TemporalType temporalType) {
		if (value != null) {
