...
/**
 * {@link SQLQuery} expression resolver
 *
 * @since 5.1.0
 */
@Priority(Integer.MAX_VALUE)
public enum SQLQueryResolver implements SQLExpressionResolver<SQLQuery> {
	 ...
	 */
	@Override
	public Class<? extends SQLQuery> getExpressionType() {
	 ...
	 */
	@Override
	public Optional<SQLExpression> resolve(SQLQuery expression, SQLCompositionContext context)
			throws InvalidExpressionException {

		// validate
		expression.validate();

		return Optional.of(SQLExpression.create(expression.getSql()));
	}
