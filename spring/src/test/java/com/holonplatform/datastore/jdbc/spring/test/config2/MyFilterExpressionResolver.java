...
@DatastoreResolver
public class MyFilterExpressionResolver implements QueryFilterResolver<MyFilter> {
	...
	@Override
	public Optional<QueryFilter> resolve(MyFilter flt, ResolutionContext ctx) throws InvalidExpressionException {
		return Optional.of(flt.getProperty().eq("test"));
	}
