...
<3> Provide a `DataSourceConfigProperties` structure using the `jdbc.properties` file, to build and configure a DataSource according to the available properties. See link:../../holon-core/jdbc.html#jdbc-datasource-configuration[JDBC DataSource]
